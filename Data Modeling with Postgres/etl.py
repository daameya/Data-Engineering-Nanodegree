...
def process_data(cur, conn, filepath, func):
    ...
    Parameters:
        cur (psycopg2.cursor()): Cursor of the sparkifydb database
        conn (psycopg2.cursor()): connection to the sparkifydb database
...
def main():
    """ Function used to extract, transform all data from song and user activity logs and load it into a
    postgreSQL DB
